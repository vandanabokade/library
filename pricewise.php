...
require('menu.php');
    require('connect.php');
    $q="select * from book order by price desc";
    $result=mysqli_query($mysql,$q) or die("Error..".mysqli_error($mysql));
    if(mysqli_num_rows($result)>0){
        echo "<caption><h3 align='center' style='margin-top:20px;margin-bottom:20px;'>Display Books in descending order of Price </h3></caption>";
